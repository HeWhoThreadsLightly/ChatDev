...
class GlueModelWrapper(ModelBackend):
    ...
    def __init__(self, model_type: ModelType, model_config_dict: Dict) -> None:
        ...
        self.glue_model: GlueModel = ChatDevGlueModelGlobal.get()
    ...
    def run(self, *args, **kwargs):
        ...
        # TODO make token usage a port of glue ladder if possible
        num_max_token_map = {
            "gpt-3.5-turbo": 4096,
        ...
        response = self.glue_model.prompt(*args, **kwargs, model=self.model_type.value,
...
class ModelFactory:
    ...
    def create(model_type: ModelType, model_config_dict: Dict) -> ModelBackend:
        ...
        elif model_type == ModelType.LLM_GLUE:
            model_class = GlueModelWrapper
